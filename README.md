...
- 新增一键部署签到程序：依赖自动安装、触发器自动配置，可能是全网最快、选择最多的部署 👇 (我们支持三种配置方式，请按需选择，点击左边小三角展开教程)
  ...
  **你需要添加 2 个 secrets，他们的示例如下：**
  ...
  - `school`: e.g. `whpu` 学校的英文简称（推荐，部分学校支持，请查阅[支持英文简称的学校列表](https://github.com/beetcb/cea/edit/master/README.md#addrlist)自行判断）或中文全称（备用选项，所有学校都支持）
  ...
  3. 教程结束 ⚡ (如有问题，请附带日志提交 issue)，此函数会自动在每天 5:00 11:00 16:00 触发，具体的配置文件示例如下：
     ...
     ```toml
     # 学校的英文简称（推荐，部分学校支持，请参阅[支持英文简称的学校列表](https://github.com/beetcb/cea/edit/master/README.md#addrlist)自行判断）或中文全称（备用选项，所有学校都支持）
     school = "whpu"
...
<details id="addrlist"><summary>支持使用英文简称的学校列表如下</summary>
...
- (可选)使用文件配置用户: 根目录下创建 `conf.toml`, 参考以下示例:
  ...
  # 学校的英文简称（推荐，部分学校支持，请查阅[支持英文简称的学校列表](https://github.com/beetcb/cea/edit/master/README.md#addrlist)自行判断）或中文全称（备用选项，所有学校都支持）
  school = "whpu"
